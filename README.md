...
| 设备 | 场景 | 说明 |
|------|------|------|
| DEV_A_NORMAL | A | 完全正常，180 天 |
| DEV_B_SICK | B | 第 60-80 天皮肤病爆发后康复 |
| DEV_C_SEASON | C | 季节性升高，温度系数 0.25，温度修正后不误报 |
| DEV_D_ALLERGY | D | 过敏缓慢加重，基线追上后不误报 |
| DEV_E1_UNWORN | E1 | 忘记佩戴（第 35-37 天缺口） |
| DEV_E2_BATTERY | E2 | 没电缺口（第 40-44 天）+ 缺口后皮肤病 |
| DEV_E3_SIGNAL | E3 | 信号不稳定（第 20-80 天间歇丢失） |
| DEV_E4_LOOSE | E4 | 项圈松动（第 50-57 天数据无效） |
